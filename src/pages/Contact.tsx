...
const guestbookEntries = [
  { id: 1, name: "Uncle Tom", date: "July 10, 2024", message: "What a wonderful website! It's so great to have all our memories in one place. Looking forward to the reunion!" },
  { id: 2, name: "Cousin Lisa", date: "June 28, 2024", message: "Love seeing all the family photos! This brings back so many happy memories. Can't wait to add more at the next gathering!" },
  { id: 3, name: "Aunt Patricia", date: "June 15, 2024", message: "The recipe section is amazing! I finally got Grandma's apple pie recipe right thanks to the detailed instructions here." },
];
...
const Contact = () => {
  ...
  const handleGuestbookSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    toast({ title: "Guestbook Entry Submitted!", description: "Your message will appear after moderation. Thank you!" });
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12 animate-fade-in">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            {get("contact_header", "content", "Have a question, suggestion, or just want to say hello? We'd love to hear from you!")}
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <Card className="p-6 lg:col-span-1">
              ...
              <form onSubmit={handleGuestbookSubmit} className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-heading mb-2">Your Name</label>
                  <Input type="text" placeholder="Name" value={guestbookData.name} onChange={(e) => setGuestbookData({ ...guestbookData, name: e.target.value })} required />
                </div>
                <div>
            ...
            <div className="lg:col-span-2 space-y-4">
              {guestbookEntries.map((entry, index) => (
                <Card key={entry.id} className="p-6 animate-fade-in-up" style={{ animationDelay: `${index * 0.1}s` }}>
